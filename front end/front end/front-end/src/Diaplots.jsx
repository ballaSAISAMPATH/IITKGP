...
const ChartComponent = ({ res, isSubmitted }) => {
  ...
  const barData1 = [
    { name:res.data.detailed_report.sentiment_terms.Negative[0][0], negatives: barplotNegative1 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Negative[1][0], negatives: barplotNegative2 * 100 },
    { name:res.data.detailed_report.sentiment_terms.Negative[2][0], negatives: barplotNegative3 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Negative[3][0], negatives: barplotNegative4 * 100 },
  ];
  const barData2 = [
    { name:res.data.detailed_report.sentiment_terms.Positive[0][0], Positives: barplotNegative5 * 100 },
    { name:res.data.detailed_report.sentiment_terms.Positive[1][0], Positives: barplotNegative6 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Positive[2][0], Positives: barplotNegative7 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Positive[3][0], Positives: barplotNegative8 * 100 },
  ];
  const barData3 = [
    { name:res.data.detailed_report.sentiment_terms.Neutral[0][0], Neutrals: barplotNegative9 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Neutral[1][0], Neutrals: barplotNegative10 * 100 },
    { name:res.data.detailed_report.sentiment_terms.Neutral[2][0], Neutrals: barplotNegative11 * 100 },
    { name: res.data.detailed_report.sentiment_terms.Neutral[3][0], Neutrals: barplotNegative12 * 100 },
  ];
